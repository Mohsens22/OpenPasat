...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pasat.Models.TestAnswer", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Pasat.Models.TestFragment", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Pasat.Models.TestIndentifier", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Pasat.Models.User", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Pasat.Models.TestAnswer", b =>
                {
                    b.HasOne("Pasat.Models.TestIndentifier", "Indentifier")
                        .WithMany("Answers")
                        .HasForeignKey("IndentifierId");

                    b.HasOne("Pasat.Models.TestFragment", "PreFragment")
                        .WithOne("PreFragmentOf")
                        .HasForeignKey("Pasat.Models.TestAnswer", "PreFragmentId");

                    b.HasOne("Pasat.Models.TestFragment", "TestFragment")
                        .WithOne("FragmentOf")
                        .HasForeignKey("Pasat.Models.TestAnswer", "TestFragmentId");
                });
            ...
            modelBuilder.Entity("Pasat.Models.TestIndentifier", b =>
                {
                    b.HasOne("Pasat.Models.User", "User")
                        .WithMany("Tests")
